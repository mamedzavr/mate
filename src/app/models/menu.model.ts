...
export const starterItems: Dish[] = [
  {
...
export const noodlesItems: Dish[] = [
  {
    name: 'Chicken Noodle',
    price: 15,
    ingredients: [
...
export function getMenuItems(): Dish[] {
  return [...soupItems, ...saradaItems, ...starterItems, ...noodlesItems];
}
